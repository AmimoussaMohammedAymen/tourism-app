...
class AlgTripDetailsScreen extends StatelessWidget {
  static const screenRout = '/Alg-trip-details';
  final Function manageFavorite;
  final Function isFavorite;

  AlgTripDetailsScreen(this.manageFavorite, this.isFavorite);
  ...
  Widget build(BuildContext ctx1) {
    ...
    final selectedTrip = Alg_Trips_data.firstWhere(((trip) => trip.id == tripId));
    return Scaffold(
        appBar: AppBar(
