...
class AnnabaTripDetailsScreen extends StatelessWidget {
  static const screenRout = '/Annaba-trip-details';
  final Function manageFavorite;
  final Function isFavorite;

  AnnabaTripDetailsScreen(this.manageFavorite, this.isFavorite);
  ...
  Widget build(BuildContext ctx1) {
    ...
    final selectedTrip = Annaba_Trips_data.firstWhere(((trip) => trip.id == tripId));
    return Scaffold(
        appBar: AppBar(
