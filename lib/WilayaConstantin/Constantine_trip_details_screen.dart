...
class ConstantineTripDetailsScreen extends StatelessWidget {
  static const screenRout = '/Constantine-trip-details';
  final Function manageFavorite;
  final Function isFavorite;

  ConstantineTripDetailsScreen(this.manageFavorite, this.isFavorite);
  ...
  Widget build(BuildContext ctx1) {
    ...
    final selectedTrip = Constantine_Trips_data.firstWhere(((trip) => trip.id == tripId));
    return Scaffold(
        appBar: AppBar(
