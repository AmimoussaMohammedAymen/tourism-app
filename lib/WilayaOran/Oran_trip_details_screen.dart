...
class OranTripDetailsScreen extends StatelessWidget {
  static const screenRout = '/Oran-trip-details';
  final Function manageFavorite;
  final Function isFavorite;

  OranTripDetailsScreen(this.manageFavorite, this.isFavorite);
  ...
  Widget build(BuildContext ctx1) {
    ...
    final selectedTrip = Oran_Trips_data.firstWhere(((trip) => trip.id == tripId));
    return Scaffold(
        appBar: AppBar(
