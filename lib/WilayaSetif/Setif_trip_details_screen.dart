...
class SetifTripDetailsScreen extends StatelessWidget {
  static const screenRout = '/Setif-trip-details';
  final Function manageFavorite;
  final Function isFavorite;

  SetifTripDetailsScreen(this.manageFavorite, this.isFavorite);
  ...
  Widget build(BuildContext ctx1) {
    ...
    final selectedTrip = Setif_Trips_data.firstWhere(((trip) => trip.id == tripId));
    return Scaffold(
        appBar: AppBar(
